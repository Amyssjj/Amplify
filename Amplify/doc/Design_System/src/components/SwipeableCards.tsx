...
export function SwipeableCards({ recording, currentPlayTime, isPlaying, onTranscriptExpand, onInsightsExpand }: SwipeableCardsProps) {
  ...
  // Static card component that doesn't re-render on playback updates
            ...
            >
              <div className="flex flex-col gap-3">
                <div className="flex-1">
                  ...
                  {insight.suggestion && (
                    <motion.div 
                      className="mt-2 p-2 bg-gray-50 rounded text-xs font-medium text-gray-700 border border-gray-200"
      ...
      >
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              {currentCard === 'transcript' ? <TranscriptCard /> : <InsightsCard />}
            </motion.div>
          </AnimatePresence>
        </motion.div>
      </motion.div>
